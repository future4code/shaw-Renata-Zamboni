...
export function ApplicationFormPage() {
    ...
    //state pra cada item do body/form que recebe um input
   ...
   //useEffect+ axios + map para GET trip
    useEffect(()=>{
    ...
    const chooseTrip =  getTrip && getTrip.map((trip)=>{
        return(
    ...
    //Uma função de evento pra cada input  
    ...
    <ApplicationFormPageBox>
        ...
        <form>
			<label>
                Escolha uma viagem:
                <br/>				
				<select onChange={onChangeTrip} value={getTrip}>
					{chooseTrip}						
				</select>
			</label>
		</form>
        ...
        <br/>
        <input placeholder="Nome"type="text" onChange={onChangeNome} value={nome}></input><br/>

        <br/><input placeholder="Idade" type="number" onChange={onChangeIdade} value={idade}></input><br/>

        <br/><input placeholder="Profissão" type="text" onChange={onChangeProfissao} value={profissao}></input><br/>
        ...
        <form>
            <label>
                ...
                <br/>
                <textarea onChange={onChangeTextoCandidatura} value={textoCandidatura}/>
            </label>
        </form>
                 
        {/*passo 2.2 - <CountrySelect value={pais} onChange={onChangePais}/> */ }      
        ...
        <br/>
        <button onClick={applyToTrip} value={postApply}>Enviar Inscrição</button>
